...
static void DemoWindowWidgetsBasic()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        ImGui::TextLinkOpenURL("Hyperlink", "https:
...
static void DemoWindowWidgetsSelectionAndMultiSelect(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Selection State & Multi-Select"))
    {
        ...
        ImGui::SameLine();
        ImGui::TextLinkOpenURL("imgui/wiki/Multi-Select", "https:
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    ImGui::TextLinkOpenURL("Homepage", "https:
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("FAQ", "https:
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Wiki", "https:
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Extensions", "https:
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Releases", "https:
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Funding", "https:
